...
export default function ServicesAlt() {
  ...
  return (
    <section className="py-20 bg-[#F7FAFD] relative overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={fadeInUp}
            className="text-4xl sm:text-5xl font-black text-[#0B1F3A] leading-tight"
          >
        ...
        <motion.div
          ...
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          className="grid grid-cols-1 md:grid-cols-3 rounded-2xl overflow-hidden bg-white border border-gray-100"
        >
          {services.map((s, idx) => (
            <motion.div key={s.number} variants={fadeInUp}>
              ...
              >
                ...
                {/* Number watermark */}
                <span className="absolute top-8 left-8 text-5xl font-black text-gray-100 group-hover:text-white/15 transition-colors duration-500 select-none">
                  {s.number}
                </span>

                {/* Icon badge */}
                <div className="relative z-10 flex justify-center mb-8">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center bg-white border border-gray-200 text-[#0B1230] group-hover:bg-white/15 group-hover:border-white/30 group-hover:text-white transition-colors duration-500">
                    {s.icon}
                  </div>
                </div>

                {/* Title */}
                <h3 className="relative z-10 text-xl font-bold text-center mb-4 text-[#0B1230] group-hover:text-white transition-colors duration-500">
                  {s.title}
                </h3>
                ...
                <div className="relative z-10 text-center flex-1">
                  <p className="font-bold text-sm mb-1 text-[#0B1230] group-hover:text-white transition-colors duration-500">
                    {s.brand}
                  </p>
                  <p className="text-sm leading-relaxed text-gray-500 group-hover:text-white/85 transition-colors duration-500">
                    {s.tagline}
                  </p>
                </div>
                ...
                <div className="relative z-10 flex justify-center mt-8">
                  <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold border transition-colors duration-500 bg-white text-[#0B1230] border-gray-200 group-hover:bg-[#0B1230] group-hover:text-white group-hover:border-[#0B1230]">
                    Read More
