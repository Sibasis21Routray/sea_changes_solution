...
export default function ServicesAlt() {
  return (
    <section className="py-20 bg-[#F7FAFD] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mb-14">
          <h2 className="text-4xl sm:text-5xl font-black text-[#0B1F3A] leading-tight">
            ...
            <span className="text-[#5B63D3]">thrive.</span>
          </h2>
        </div>

        {/* Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 rounded-2xl overflow-hidden bg-white border border-gray-100">
          {services.map((s, idx) => (
            <Link
              key={s.number}
              to={s.path}
            ...
            >
              ...
              {/* Icon badge, top-center, switches style on hover */}
              <div className="relative z-10 flex justify-center mb-8">
                <div
                  className="
                    w-16 h-16 rounded-full flex items-center justify-center
                    bg-white border border-gray-200 text-[#0B1230]
                    group-hover:bg-white/15 group-hover:border-white/30 group-hover:text-white
                    transition-colors duration-500
                  "
                >
                  {s.icon}
              ...
              <h3
                className="
                  relative z-10 text-xl font-bold text-center mb-4
              ...
              <span
                className="
                  ...
                  bg-[#FF5A1F] group-hover:bg-white
                  transition-colors duration-500
                "
              />
