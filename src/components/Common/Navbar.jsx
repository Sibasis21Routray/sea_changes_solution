...
export default function Navbar() {
  ...
  />
        ...
        <div className="hidden lg:block">
          <Link
            to="/contact"
            className="bg-[#3D5AFE] text-white text-sm font-semibold px-6 py-3 rounded-full hover:bg-[#3049d6] transition-all hover:shadow-lg hover:shadow-blue-500/30 duration-200"
          >
      ...
      >
        <div className="bg-[#0A1628] border-t border-white/10 px-4 py-4 flex flex-col gap-1">
          ...
          <Link
            to="/contact"
            className="mt-2 bg-[#3D5AFE] text-white text-sm font-semibold px-6 py-3 rounded-full text-center hover:bg-[#3049d6] transition-colors"
          >
            Schedule Consultation
          </Link>
        </div>
